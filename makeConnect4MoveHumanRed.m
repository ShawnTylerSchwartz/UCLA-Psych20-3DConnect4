function [updatedBoard, player, x_loc, y_loc, z_loc] = makeConnect4MoveHumanRed(board, currentPlayer)
...
dlg_title = 'Red Turn'; %title
answer = inputdlg(prompt,dlg_title);
slice = str2num(answer{1}); %getting the input
